...
# Cleave Session Relay — Handoff Protocol
...
Context quality degrades as usage increases:
...
**CRITICAL:** APPEND to this file. Do NOT overwrite or reorganize existing content. The relay script auto-prunes old Session Log entries (keeps last 5), so promote anything permanently valuable to Core Knowledge before it's lost.
